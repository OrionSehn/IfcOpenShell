...
class BIMRailingProperties(PropertyGroup):
    ...
    use_manual_supports: bpy.props.BoolProperty(name="Use Manual Supports", default=False, 
    ...
    support_spacing: bpy.props.FloatProperty(name="Support Spacing", default=1.0, 
    ...
    clear_width: bpy.props.FloatProperty(name="Clear Width", default=0.040, 
